...
class Response:
    ...
    def __init__(self, response: [dict, None], errors: [List[Error], None]):
...
class SensorDataProcessor:
    ...
    def process_data(self, msgs: List[Response], topic, name):
...
class ErrorHandler:
    ...
    def handle_error(self, errors: List[List[Error]], *args, **kwargs):
